...
#Region "Form Methods"
    Private Sub frmMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        SurlignerLaSelectionToolStripMenuItem.Text = LangIni.GetKeyValue("Popotte - EditorWindow - Menu", "97")
        ...
        TableDesCaracteresToolStripMenuItem.Text = LangIni.GetKeyValue("Popotte - EditorWindow - Menu", "38")
        ...
        EchancrureToolStripMenuItem.Text = LangIni.GetKeyValue("Popotte - EditorWindow - Menu", "70")
        ...
        OuvrirLeRepertoireDesRecettesToolStripMenuItem.Text = LangIni.GetKeyValue("Popotte - EditorWindow - Menu", "50")
        ...
        EditeurExterneParDefautToolStripMenuItem.Text = LangIni.GetKeyValue("Popotte - EditorWindow - Menu", "52")
        DossierRecetteToolStripMenuItem.Text = LangIni.GetKeyValue("Popotte - EditorWindow - Menu", "53")
        OuvrirMesLivresAuDemarrageToolStripMenuItem.Text = LangIni.GetKeyValue("Popotte - EditorWindow - Menu", "54")
        ...
        If regKey IsNot Nothing Then
            ...
            If Word <> "" Then
                ...
                If Position <> 0 Then
                    ...
                    Dim psi As New ProcessStartInfo With {.FileName = Link, .UseShellExecute = True}
                    Process.Start(psi)
    ...
    Public Sub askforexamples()
        ...
        If answer = Global.System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub frmMain_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
        ...
        demarrage = True
        If VerUpdate = 1 Then
            VerifierSiUneMiseAJourEstDisponibleAuDemarrageToolStripMenuItem.Checked = True
        ...
        If ParseCommandLineArgs() <> 1 Then
            ...
            If LivreDem = 1 Then
                OuvrirMesLivresAuDemarrageToolStripMenuItem.Checked = True
                ToolStripMenuItemLivres_Click(Me, e)
            Else
                OuvrirMesLivresAuDemarrageToolStripMenuItem.Checked = False
            End If
            ...
            If DerRecette = 1 Then
                OuvrirLaDerniereRecetteAuDemarrageToolStripMenuItem.Checked = True
                ...
                End If
            Else
                OuvrirLaDerniereRecetteAuDemarrageToolStripMenuItem.Checked = False
            End If
        End If
    End Sub
    ...
    Public Sub GetCharFormat()
        If rtbDoc.SelectionFont IsNot Nothing Then
            ...
            If rtbDoc.SelectionAlignment = ExtendedRichTextBox.TextAlign.Left Then
                ToolStripButtonGauche.Checked = True
                TexteÀGaucheToolStripMenuItem.Checked = True
            Else
            ...
            End If
            If rtbDoc.SelectionAlignment = ExtendedRichTextBox.TextAlign.Center Then
            ...
            End If
            If rtbDoc.SelectionAlignment = ExtendedRichTextBox.TextAlign.Right Then
            ...
            End If
            If rtbDoc.SelectionAlignment = ExtendedRichTextBox.TextAlign.Justify Then
...
#Region "Menu Methods"
    ...
    Private Sub NewToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NewToolStripMenuItem.Click
        ...
        If rtbDoc.Modified Then
            ...
            Select Case answer
                Case Global.System.Windows.Forms.DialogResult.Cancel
                    Exit Sub
                Case Global.System.Windows.Forms.DialogResult.No
                    rtbDoc.Clear()
                    SetDefaultFont()
                    rtbDoc.Focus()
                Case Global.System.Windows.Forms.DialogResult.Yes
                    SaveToolStripMenuItem_Click(Me, e)
                    rtbDoc.Clear()
                    SetDefaultFont()
                    rtbDoc.Focus()
        ...
        Me.Text = "Popotte"
        LivreOuvert = ""
        rtbDoc.SelectionAlignment = ExtendedRichTextBox.TextAlign.Left
        ToolStripButtonGauche.Checked = True
        ToolStripButtonCentre.Checked = False
        ToolStripButtonDroite.Checked = False
        TexteÀGaucheToolStripMenuItem.Checked = True
    ...
    Private Sub SelectFontToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles SelectFontToolStripMenuItem.Click
        ...
        If FontDialog1.ShowDialog() = Global.System.Windows.Forms.DialogResult.OK Then
    ...
    Private Sub TableDesCaracteresToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles TableDesCaracteresToolStripMenuItem.Click
        Process.Start("charmap.exe")
    End Sub


    Private Sub OuvrirLeRepertoireDesRecettesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles OuvrirLeRepertoireDesRecettesToolStripMenuItem.Click
        Dim psi As New ProcessStartInfo()
        psi.FileName = PopotteDir
    ...
    Private Sub DisableControl()
        ...
        SurlignerLaSelectionToolStripMenuItem.Enabled = False
    ...
    Private Sub EnableControl()
        ...
        SurlignerLaSelectionToolStripMenuItem.Enabled = True
    ...
    Private Sub OuvrirMesLivresAuDemarrageToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles OuvrirMesLivresAuDemarrageToolStripMenuItem.Click
        regKey = Registry.CurrentUser.OpenSubKey("Software\Popotte\Settings\LivreDem", True)
        If regKey Is Nothing Then
            regKey = Registry.CurrentUser.OpenSubKey("Software\Popotte\Settings\", True)
        ...
        If OuvrirMesLivresAuDemarrageToolStripMenuItem.Checked Then
            OuvrirMesLivresAuDemarrageToolStripMenuItem.Checked = False
            regKey.SetValue("check", 0)
        Else
            OuvrirMesLivresAuDemarrageToolStripMenuItem.Checked = True
    ...
    Private Sub OuvrirLaDerniereRecetteAuDemarrageToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles OuvrirLaDerniereRecetteAuDemarrageToolStripMenuItem.Click
        regKey = Registry.CurrentUser.OpenSubKey("Software\Popotte\Settings\DerRecette", True)
        If OuvrirLaDerniereRecetteAuDemarrageToolStripMenuItem.Checked Then
            OuvrirLaDerniereRecetteAuDemarrageToolStripMenuItem.Checked = False
            regKey.SetValue("check", 0)
        Else
            OuvrirLaDerniereRecetteAuDemarrageToolStripMenuItem.Checked = True
    ...
    Private Sub SaveBD_ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SaveBD_ToolStripMenuItem.Click
        ...
        If SaveFileDialog1.ShowDialog = Global.System.Windows.Forms.DialogResult.Cancel Then
            SaveFileDialog1.Dispose()
            Exit Sub
        End If
    ...
    Private Sub AidesToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles AidesToolStripMenuItem1.Click
        ...
        If Language = "Francais" Then
            Process.Start("explorer", Application.StartupPath & "Popotte Francais.pdf")
        Else
            Process.Start("explorer", Application.StartupPath & "Popotte English.pdf")
        End If
    ...
    End Sub
    Private Sub VerifierSiUneMiseAJourEstDisponibleAuDemarrageToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles VerifierSiUneMiseAJourEstDisponibleAuDemarrageToolStripMenuItem.Click
        regKey = Registry.CurrentUser.OpenSubKey("Software\Popotte\Settings\VerUpdate", True)
        If regKey Is Nothing Then
            regKey = Registry.CurrentUser.OpenSubKey("Software\Popotte\Settings\", True)
        ...
        If VerifierSiUneMiseAJourEstDisponibleAuDemarrageToolStripMenuItem.Checked Then
            VerifierSiUneMiseAJourEstDisponibleAuDemarrageToolStripMenuItem.Checked = False
            regKey.SetValue("check", 0)
        Else
            VerifierSiUneMiseAJourEstDisponibleAuDemarrageToolStripMenuItem.Checked = True
            regKey.SetValue("check", 1)
    ...
    Private Sub ToolStripMenuItemArchiverLesRecettes_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItemArchiverLesRecettes.Click
        If IsDirectoryEmpty(PopotteDir) = False Then
            ...
            Try
                ZipFile.CreateFromDirectory(PopotteDir, SaveFileDialog1.FileName, CompressionLevel.Optimal, False)
    ...
    Private Sub EditeurExterneParDefautToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EditeurExterneParDefautToolStripMenuItem.Click
        Dim ppath As String = ""
    ...
    Private Sub SurlignerLaSelectionToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SurlignerLaSelectionToolStripMenuItem.Click
    ...
    Private Sub CouleurDeSurbrillanceToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CouleurDeSurbrillanceToolStripMenuItem.Click
        ...
        If ColorDialog1.ShowDialog = Global.System.Windows.Forms.DialogResult.OK Then
...
#Region "Contextmenu Methods"
    ...
    Private Sub SurlignerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SurlignerToolStripMenuItem.Click
        SurlignerLaSelectionToolStripMenuItem_Click(Me, e)
    End Sub
...
#Region "Toolbar Methods"
    ...
    Private Sub ToolStripButtonCentre_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButtonCentre.Click
        rtbDoc.SelectionAlignment = ExtendedRichTextBox.TextAlign.Center
        ToolStripButtonCentre.Checked = True
        ToolStripButtonDroite.Checked = False
        ToolStripButtonGauche.Checked = False
        JustifyToolStripButton.Checked = False
    ...
    Private Sub ToolStripButtonDroite_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButtonDroite.Click
        rtbDoc.SelectionAlignment = ExtendedRichTextBox.TextAlign.Right
        ToolStripButtonDroite.Checked = True
        ToolStripButtonGauche.Checked = False
        ToolStripButtonCentre.Checked = False
        JustifyToolStripButton.Checked = False
    ...
    Private Sub JustifyToolStripButton_Click(sender As Object, e As EventArgs) Handles JustifyToolStripButton.Click
        rtbDoc.SelectionAlignment = ExtendedRichTextBox.TextAlign.Justify
        JustifyToolStripButton.Checked = True
        ToolStripButtonDroite.Checked = False
        ToolStripButtonGauche.Checked = False
        ToolStripButtonCentre.Checked = False
